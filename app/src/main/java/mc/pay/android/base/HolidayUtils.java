...
//    }
    ...
    public static void main(String[] args) {
        System.out.println("20150217        : " + HolidayUtils.isHoliday("20150217"));
        System.out.println("20150218 (음력) : " + HolidayUtils.isHoliday("20150218")); // 설날 - 전날
        System.out.println("20150219 (음력) : " + HolidayUtils.isHoliday("20150219")); // 설날
        System.out.println("20150220 (음력) : " + HolidayUtils.isHoliday("20150220")); // 설날 - 다음날
        System.out.println("20150221        : " + HolidayUtils.isHoliday("20150221"));
        System.out.println("20151225 (양력) : " + HolidayUtils.isHoliday("20151225")); // 크리스마스
        System.out.println("20151226        : " + HolidayUtils.isHoliday("20151226"));
        System.out.println("20150929 (대체) : " + HolidayUtils.isHoliday("20150929")); // 대체 휴일
    }
